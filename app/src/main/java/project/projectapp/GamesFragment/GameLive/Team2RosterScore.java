...
public class Team2RosterScore extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.team_2_live_fragment, container, false);
                    ...
                    for(DataSnapshot perGame : games.getChildren()){
                        if(perGame.getKey().equals("GameId")){
                            if(perGame.getValue().toString().equals(gameId)){
                                getTeamData(games, "Team 2", teamPlayers, teamNumbers,
    ...
    private void recyclerViewSetup(View view) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recycler_view_live_game_team_2);
