...
public class OfficiateGameTeam1RosterScore extends Fragment {
    ...
    private void recyclerViewSetup(View view){
        RecyclerView recyclerView = view.findViewById(R.id.officiate_game_team_1_recycler_view);
        OfficiateGameRecyclerViewAdapter adapter =
                new OfficiateGameRecyclerViewAdapter(getContext(), playerNames, playerNumbers,
                        onePointers, twoPointers, threePointers, fouls, gameId, "Team 1");
