...
public class Team2ResultFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.team_2_result_fragment, container, false);
                    ...
                    for(DataSnapshot teamData : data.getChildren()){
                        if(teamData.getKey().equals("GameId")){
                            if(teamData.getValue().toString().equals(gameId)){
                                getTeamData(data, "Team 2", team1Players, team1Numbers,
    ...
    private void recyclerViewSetupTeam1(final View view) {
        RecyclerView recyclerView = view.findViewById(R.id.recycler_view_team_2_breakdown);
